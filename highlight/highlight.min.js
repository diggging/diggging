...
contains:[l,e.SHEBANG(),s,b,g,o,v,m,c]}}})());hljs.registerLanguage("elm",(()=>{"use strict";return e=>{const n={
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}],illegal:/;/}}})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
...
}),n,{begin:"->|<-"}]}}})());hljs.registerLanguage("wasm",(()=>{"use strict";return e=>{
...
className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,p,o]}]}}})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
contains:p}}})());hljs.registerLanguage("livescript",(()=>{"use strict"
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("nix",(()=>{"use strict";return e=>{const n={
...
aliases:["nixos"],keywords:n,contains:t}}})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
...
relevance:0}]}}})());hljs.registerLanguage("profile",(()=>{"use strict";return e=>({
...
end:"\\)$",excludeBegin:!0,excludeEnd:!0,relevance:0}]})})());hljs.registerLanguage("clojure",(()=>{"use strict";return e=>{
...
illegal:/\S/,contains:[f,i,m,p,c,u,l,o,d]}}})());hljs.registerLanguage("clojure-repl",(()=>{"use strict";return e=>({
...
},...B,..._,...M,I,P,...z,...q,U,V]}}})());hljs.registerLanguage("ocaml",(()=>{"use strict";return e=>({name:"OCaml",
...
relevance:0},{begin:/->/}]})})());hljs.registerLanguage("verilog",(()=>{"use strict";return e=>({name:"Verilog",
...
},relevance:0}]})})());hljs.registerLanguage("vbnet",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
return n.map((n=>e(n))).join("")}function t(...n){return"("+((e=>{
const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
...
},{begin:s+":",end:":",returnBegin:!0,returnEnd:!0,relevance:0}]}}})());hljs.registerLanguage("php-template",(()=>{"use strict";return n=>({
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:c}}})());hljs.registerLanguage("scheme",(()=>{"use strict";return e=>{
...
name:"Scheme",illegal:/\S/,contains:[e.SHEBANG(),a,i,l,g,d].concat(c)}}})());hljs.registerLanguage("sql",(()=>{"use strict";function e(e){
...
className:"meta",begin:"#",end:"$"}]})})());hljs.registerLanguage("erlang",(()=>{"use strict";return e=>{
