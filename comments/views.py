...
def add_question_comment(request):
    ...
    comment = Comment.objects.create(
        question=post, text=comment_content, user=request.user
    )
    comment.save()
...
def add_answer_comment(request):
    ...
    answer_comment = Comment.objects.create(
        answer=answer, text=answer_comment_content, user=request.user
    )
    answer_comment.save()
    new_alarm = Alarm.objects.create(
        user=answer.user,
